...
function changeAdImage(src, element){
...
# ============================================================
# LUCAS PUBLIC AD NUMBERS
# #1 #2 #3 ...
# ============================================================

def lucas_prepare_public_ad_numbers():
    ...
    try:
        ...
        if rows:
            ...
            row_count = c.execute(
                "SELECT COUNT(*) FROM ads WHERE ad_number IS NOT NULL"
            ).fetchone()[0]

            number = int(row_count) + 1
        ...
        print("PUBLIC AD NUMBER ERROR:", e)


lucas_prepare_public_ad_numbers()


def lucas_public_ad_code(ad):
...
<div class="top">
    🛒 LUCAS SHOP
    <span class="code">#{{ ad['ad_number'] }}</span>
</div>
...
<img
    ...
    src="{{ image }}"
    onclick="changeAdImage('{{ image }}', this)"
>
