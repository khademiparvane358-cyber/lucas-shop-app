...
# ============================================================
# LUCAS SHOP - FINAL AD TEMPLATE V3
# فقط قالب نمایش آگهی - بدون تغییر فرم ثبت آگهی
# ============================================================

from flask import redirect

def _LUCAS_GET(row, *names, default="ثبت نشده"):
    for name in names:
        try:
            v = row[name]
        except Exception:
...
def _LUCAS_FIND_AD_V3(code):
    ...
    try:
        if str(code).upper().startswith("LS-"):
            row = db.execute(
...
def _LUCAS_AD_IMAGES_V3(ad):
    result = []

    for field in ("image1", "image2", "image3", "image"):
        try:
            value = ad[field]
        except Exception:
            try:
...
@app.route("/ad/<code>", methods=["GET"])
def lucas_final_ad_template_v3(code):

    ad = _LUCAS_FIND_AD_V3(code)
    ...
    for img in images:
        ...
        if img.startswith("http://") or img.startswith("https://"):
            ...
            image_urls.append("/uploads/" + img)

    if not image_urls:
        image_urls = ["/static/placeholder.png"]
    ...
    for i, img in enumerate(image_urls):
        ...
        thumbs += f'''
        <button class="lucas-thumb{active}"
                type="button"
                onclick="lucasShowImage('{img}',this)">
    ...
    # متن‌ها
    # --------------------------------------------------------
    name_change_text = str(name_change)

    if name_change_text.lower() in ("1", "yes", "true", "بله", "دارد"):
        name_change_text = "دارد"
    elif name_change_text.lower() in ("0", "no", "false", "خیر", "ندارد"):
        name_change_text = "ندارد"

    supercell_text = str(supercell)

    if supercell_text.lower() in ("1", "yes", "true", "بله", "دارد"):
        supercell_text = "متصل است"
    elif supercell_text.lower() in ("0", "no", "false", "خیر", "ندارد"):
        supercell_text = "متصل نیست"
...
<title>آگهی #{ad_number} | LUCAS SHOP</title>
...
<div class="lucas-page">

    <div class="lucas-title">
        <h1>🛒 LUCAS SHOP</h1>
        <div class="code">کد آگهی #{ad_number}</div>
    </div>

    <div class="lucas-frame">

        <div class="lucas-layout">

            <!-- تصاویر -->
            <div class="lucas-gallery">

                <div class="lucas-main-image">
                    <img
                        id="lucasMainImage"
                        src="{main_image}"
                        alt="تصویر آگهی"
            ...
            <div class="lucas-info">
                ...
                <div class="lucas-account">

                    <div class="lucas-account-label">
                        نام اکانت
                    </div>

                    <div class="lucas-account-name">
                        {account_name}
                    </div>

                </div>

                <div class="lucas-grid">

                    <div class="lucas-box">
                        <div class="lucas-box-label">
                            🏰 تاون هال
                        </div>
                        <div class="lucas-box-value">
                            {townhall}
                        </div>
                    </div>
                ...
                <div class="lucas-heroes">

                    <div class="lucas-section-title">
                        ⚔️ هیروها
                    </div>

                    <div class="lucas-hero-grid">

                        <div class="lucas-hero">
                            <div class="lucas-hero-name">
                                Barbarian King
                            </div>
                            <div class="lucas-hero-value">
                                {king}
                            </div>
                        </div>
                ...
                <div class="lucas-price">

                    <div class="lucas-price-label">
                        💰 قیمت
                    </div>

                    <div class="lucas-price-value">
                        {price}
                    </div>
    ...
    <div class="lucas-bottom">
        <a class="lucas-back" href="/explore">
            ← بازگشت به آگهی‌ها
        </a>
    </div>
...
function lucasShowImage(src, button) {{

    var main = document.getElementById("lucasMainImage");
...
# ------------------------------------------------------------
# /ad/ بدون کد -> برگرد به explore
# ------------------------------------------------------------

try:
    app.add_url_rule(
        "/ad/",
        endpoint="lucas_empty_ad_v3",
...
print("======================================")
print("✅ LUCAS AD TEMPLATE V3 ACTIVE")
print("✅ COMPACT TWO-COLUMN FRAME")
print("✅ ACCOUNT NAME SHOWN")
print("✅ PLAYER TAG HIDDEN")
print("✅ TELEGRAM HIDDEN")
print("✅ TH / BH REAL VALUES")
print("✅ HERO REAL VALUES")
