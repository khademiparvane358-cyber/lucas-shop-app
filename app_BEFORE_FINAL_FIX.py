...
def sell():
    ...
    if request.method == "POST":
        ...
        # مقادیر لازم برای ستون‌های قدیمی دیتابیس
        values = {
        ...
        # فقط ستون‌هایی که واقعاً در دیتابیس هستند را وارد می‌کنیم
        existing = [r[1] for r in con.execute("PRAGMA table_info(ads)").fetchall()]
