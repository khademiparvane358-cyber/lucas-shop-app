...
<input type="hidden" name="name_change" id="name_change">
placeholder="دارد / ندارد">

<label>تعداد جم تغییر نام</label>
<div class="label">جم تغییر نام</div>
<div class="options">
<button type="button" onclick="pick('name_change_gems','500',this)">500</button>
<button type="button" onclick="pick('name_change_gems','1000',this)">1000</button>
<button type="button" onclick="pick('name_change_gems','1500',this)">1500</button>
<button type="button" onclick="pick('name_change_gems','2000',this)">2000</button>
<button type="button" onclick="pick('name_change_gems','2500',this)">2500</button>
<button type="button" onclick="pick('name_change_gems','3000',this)">3000</button>
</div>
<input type="hidden" name="name_change_gems" id="name_change_gems">

<label>Supercell ID</label>
<div class="label">Supercell ID</div>
<div class="options">
<button type="button" onclick="pick('supercell_id','دارد',this)">دارد</button>
<button type="button" onclick="pick('supercell_id','ندارد',this)">ندارد</button>
</div>
<input type="hidden" name="supercell_id" id="supercell_id">
