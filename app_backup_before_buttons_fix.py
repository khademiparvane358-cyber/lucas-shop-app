...
def sell():
    ...
    if request.method == "POST":
        ...
        for x in required:
            if not data.get(x):
                error = "لطفاً همه اطلاعات ضروری را وارد کنید."
        ...
        """,(
            ...
            data.get("warden",""),
            data.get("royal",""),
            data.get("name_change",""),
            data.get("name_change_gems",""),
            data.get("supercell_id",""),
