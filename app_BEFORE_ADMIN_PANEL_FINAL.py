...
def admin():
    ...
    html="<h1>🛠 مدیریت سایت</h1>"

    if not ads:
        html+="<div class='card'>هیچ آگهی‌ای وجود ندارد.</div>"
    else:
        for ad in ads:
            aid=ad["id"]
            title=ad["title"]
            ...
            if approved==1:
                ...
                action=f"<a class='btn' href='/admin/approve/{aid}'>✅ تأیید آگهی</a>"
    ...
    html+="<a class='btn' href='/account'>↩️ بازگشت</a>"
