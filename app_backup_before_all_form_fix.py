...
<div class="options">
<button type="button" class="level-btn" onclick="selectName('رایگان',this)">رایگان</button>
<button type="button" class="level-btn" onclick="selectName('با جم',this)">با جم</button>
</div>
...
<div class="options">
<button type="button" class="level-btn" onclick="selectGem('500',this)">500</button>
<button type="button" class="level-btn" onclick="selectGem('1000',this)">1000</button>
<button type="button" class="level-btn" onclick="selectGem('1500',this)">1500</button>
<button type="button" class="level-btn" onclick="selectGem('2000',this)">2000</button>
<button type="button" class="level-btn" onclick="selectGem('2500',this)">2500</button>
<button type="button" class="level-btn" onclick="selectGem('3000',this)">3000</button>
<button type="button" class="level-btn" onclick="selectGem('3500',this)">3500</button>
<button type="button" class="level-btn" onclick="selectGem('بیشتر',this)">بیشتر</button>
</div>
...
<div class="options">
<button type="button" class="level-btn" onclick="selectSupercell('بله متصل هست',this)">بله متصل هست</button>
<button type="button" class="level-btn" onclick="selectSupercell('خیر متصل نیست',this)">خیر متصل نیست</button>
</div>

<input type="hidden" name="supercell_id" id="supercell_id" value="">

<script>
function selectName(value,btn){
    ...
    document.getElementById("nameGemsBox").style.display =
        value==="با جم" ? "block" : "none";

    if(value==="رایگان"){
        document.getElementById("name_change_gems").value="0";
        document.getElementById("custom_gems").value="";
        document.getElementById("custom_gems").style.display="none";
    }
}

function selectGem(value,btn){
    ...
    var custom=document.getElementById("custom_gems");
...
function selectSupercell(value,btn){
...
document.addEventListener("input",function(e){
    if(e.target.id==="custom_gems"){
        document.getElementById("name_change_gems").value=e.target.value;
    }
});
</script>
